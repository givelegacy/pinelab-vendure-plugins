...
export interface SubscriptionStrategy {
     ...
     */
    isSubscription(ctx: RequestContext, variant: ProductVariant, injector: Injector): boolean | Promise<boolean>;
    /**
     ...
     */
    previewSubscription(ctx: RequestContext, injector: Injector, productVariant: ProductVariant, customInputs?: any): Promise<Subscription> | Subscription | Promise<Subscription[]> | Subscription[];
}
