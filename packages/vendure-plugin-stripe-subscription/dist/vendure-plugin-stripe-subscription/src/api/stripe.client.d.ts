 ...
 */
export declare class StripeClient extends Stripe {
    webhookSecret: string;
    constructor(webhookSecret: string, apiKey: string, config: Stripe.StripeConfig);
    getOrCreateCustomer(customer: Customer): Promise<Stripe.Customer>;
    /**
     * Throws an error if incoming webhook signature is invalid
     */
    validateWebhookSignature(payload: Buffer, signature: string | undefined): void;
    createOffSessionSubscription({ customerId, productId, currencyCode, amount, interval, intervalCount, paymentMethodId, startDate, endDate, description, orderCode, channelToken, }: SubscriptionInput): Promise<Stripe.Subscription>;
