...
/// <reference types="stripe/types/v2/core/eventdestinationsresource" />
...
/// <reference types="stripe/types/v2/eventdestinations" />
...
import { ActiveOrderService, ChannelService, EntityHydrator, EventBus, HistoryService, ID, JobQueueService, Order, OrderService, PaymentMethod, PaymentMethodService, ProductVariantService, RequestContext, SerializedRequestContext, TransactionalConnection } from '@vendure/core';
...
import { StripePaymentIntent, StripeSetupIntent } from './types/stripe-payment-intent';
...
export declare class StripeSubscriptionService {
    ...
    private connection;
    private options;
    constructor(paymentMethodService: PaymentMethodService, activeOrderService: ActiveOrderService, entityHydrator: EntityHydrator, channelService: ChannelService, orderService: OrderService, historyService: HistoryService, eventBus: EventBus, jobQueueService: JobQueueService, moduleRef: ModuleRef, connection: TransactionalConnection, productVariantService: ProductVariantService, options: StripeSubscriptionPluginOptions);
    private jobQueue;
     ...
     */
    registerWebhooks(ctx: RequestContext, paymentMethod: PaymentMethod): Promise<Stripe.Response<Stripe.WebhookEndpoint> | undefined>;
    cancelSubscriptionForOrderLine(ctx: RequestContext, orderLineId: ID): Promise<void>;
    /**
     ...
     */
    getAllSubscriptions(ctx: RequestContext, params?: Stripe.SubscriptionListParams, options?: Stripe.RequestOptions): Promise<Stripe.ApiListPromise<Stripe.Subscription>>;
    /**
     ...
     */
    handleInvoicePaymentFailed(ctx: RequestContext, invoiceId: string, order: Order): Promise<void>;
    /**
     * Handle the initial succeeded setup or payment intent.
     * Creates subscriptions in Stripe in the background via the jobqueue
     */
    handleIntentSucceeded(ctx: RequestContext, object: StripePaymentIntent | StripeSetupIntent, order: Order): Promise<void>;
    /**
     ...
     */
    saveSubscriptionIds(ctx: RequestContext, orderLineId: ID, subscriptionIds: string[]): Promise<void>;
    createContext(channelToken: string, req: Request): Promise<RequestContext>;
    /**
     ...
     */
    getStripeContext(ctx: RequestContext): Promise<StripeContext>;
    logHistoryEntry(ctx: RequestContext, orderId: ID, message: string, error?: unknown, subscription?: Subscription, subscriptionId?: any): Promise<void>;
}
export {};
